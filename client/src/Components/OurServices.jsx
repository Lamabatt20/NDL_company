...
import serviceImg9 from "../assets/images/service9.jpg";
import serviceImg10 from "../assets/images/service10.jpg";
...
export default function OurServices() {
  ...
  const getImage = (index) => {
    const imgs = [
      serviceImg1, serviceImg2, serviceImg3, serviceImg4, serviceImg5,
      serviceImg6, serviceImg7, serviceImg8, serviceImg9, serviceImg10
    ];
    return imgs[index];
  };
      ...
      <div className="service-group">
        {services.slice(5).map((service, index) => (
          <div
            ...
            style={{ transitionDelay: `${index * 0.1}s` }}
          >
            <img src={getImage(index + 5)} alt={service.title} />
            <div className="card-overlay">
              <h3>{service.title}</h3>
              <p>{service.description}</p>
            </div>
