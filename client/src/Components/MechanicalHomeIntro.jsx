      ...
      <div className="site-container">
        ...
        <div className="Mechanical-intro-wrapper">
          <div className="Mechanical-intro-text">
            <p>
              We develop high-quality mechanical designs that translate concepts
              into reliable physical systems. Our work focuses on structural
              integrity, manufacturability, and performance optimization for
